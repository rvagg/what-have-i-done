...
function compressLevel1(lines) {
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    // Detect "Commits by Repository" section
    if (line.match(/^## Commits by Repository/) || line.match(/^Repository:/)) {
    ...
    if (inCommitSection && line.match(/^## /) && !line.match(/Commits by Repository/)) {
